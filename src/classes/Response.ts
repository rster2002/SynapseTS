...
export default class Response implements ResponseInit {
    ...
    resolveExpressResponse(response: ExpressResponse, controller: Controller) {
    ...
    static respondDirectly(req: ExpressResponse, controller: Controller, init: ResponseInit = {}) {
